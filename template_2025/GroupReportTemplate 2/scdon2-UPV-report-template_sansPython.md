...
![](scdon2-UPV-report-template_sansPython_files/figure-latex/unnamed-chunk-2-1.pdf)<!-- --> 
...
{\centering \includegraphics[width=7cm]{scdon2-UPV-report-template_sansPython_files/figure-latex/unnamed-chunk-7-1} 

}

\caption{\label{fig:boxplots}Deux boxplots.}\label{fig:unnamed-chunk-7}
\end{figure}
